...
public class KafkaStreamWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String brokers = "centosvm:9092"; // a list of one or more Kafka brokers
        String groupId = "my_consumer"; // a consumer group name to consume from topics
        String topics = "pmon_all_calls_topic"; // a list of one or more kafka topics to consume from
        ...
        JavaInputDStream<ConsumerRecord<String, String>> messages = KafkaUtils
                .createDirectStream(jssc, LocationStrategies.PreferConsistent(), ConsumerStrategies.Subscribe(topicsSet, kafkaParams));

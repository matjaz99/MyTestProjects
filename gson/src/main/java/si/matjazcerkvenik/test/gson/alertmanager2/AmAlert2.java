...
public class AmAlert2 {
	
	private String receiver;
	private String status;
	private List<Alert2> alerts;
	...
	public List<Alert2> getAlerts() {
		return alerts;
	}

	public void setAlerts(List<Alert2> alerts) {
		this.alerts = alerts;
	}

	@Override
	public String toString() {
		return "AmAlert2 [receiver=" + receiver + ", status=" + status + ", alerts=" + alerts + ", groupLabels="
